...
?>
<h1 style="text-align: center">가게 게시판</h1>
...
<div class="container">
    <?php if($numMsgs>0) :?>
        <table class="table table-hover">
            ...
            <?php foreach($msgs as $msg) : ?>
                <tr>
                    <td><?= $msg["num"] ?> </td>
                    <td><b><a href="<?= bdUrl("view.php",$msg["num"],$page=$page)?>"><?= $msg["title"] ?> </a></b> </td>
                    <td><?= $msg["writer"] ?> </td>
    ...
    <span class>
        ...
        <?php if($firstPage>=1) :?>
            <li class="page-item">
                <a class="page-link" href="<?= bdUrl("board2.php",0,$firstPage-NUM_PAGE_LINKS)?>" aria-label="Previous">
        ...
        <?php for($i = $firstPage; $i<=$lastPage;$i++) :?>
            <?php if($i==$page) :?>
                <li class="page-item"><a class="page-link bg-primary text-white" href="<?= bdUrl("board2.php",0,$i)?>"><b><?= $i ?></b></a></li>
